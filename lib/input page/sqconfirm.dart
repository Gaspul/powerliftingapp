...
import 'package:powerliftingapp/confirm%20page/sqinputconfirm.dart';
import 'package:video_player/video_player.dart';

class SQConfirm extends StatefulWidget {
  const SQConfirm({super.key});

  @override
  State<SQConfirm> createState() => _SQConfirmState();
}

class _SQConfirmState extends State<SQConfirm> {
  ...
  Future<void> _pickVideo(BuildContext context) async {
    ...
    if (pickedFile != null) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SQInputConfirm(videoPath: pickedFile.path)),
      );
    }
  }
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Text(
              '4. It has to be squat workout video',
              textAlign: TextAlign.justify,
              style: TextStyle(
                color: Colors.black,
                fontSize: 16,
