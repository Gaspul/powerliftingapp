...
import 'package:powerliftingapp/confirm%20page/dlinputconfirm.dart';
import 'package:video_player/video_player.dart';

class DLConfirm extends StatefulWidget {
  const DLConfirm({super.key});

  @override
  State<DLConfirm> createState() => _DLConfirmState();
}

class _DLConfirmState extends State<DLConfirm> {
  ...
  Future<void> _pickVideo(BuildContext context) async {
    ...
    if (pickedFile != null) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DLInputConfirm(videoPath: pickedFile.path)),
      );
    }
  }
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Text(
              '4. It has to be deadlift workout video',
              textAlign: TextAlign.justify,
              style: TextStyle(
                color: Colors.black,
                fontSize: 16,
