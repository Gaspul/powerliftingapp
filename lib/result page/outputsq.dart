...
class SquatOutput extends StatefulWidget {
  final Uint8List videoBytes;

  SquatOutput({required this.videoBytes});

  @override
  _SquatOutputState createState() => _SquatOutputState();
}

class _SquatOutputState extends State<SquatOutput> {
