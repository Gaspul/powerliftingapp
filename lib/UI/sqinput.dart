...
class SQinput extends StatefulWidget {
  const SQinput({super.key,  this.title});

  final String? title;

  @override
  State<SQinput> createState() => _SQinputState();
}

class _SQinputState extends State<SQinput> {
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                ...
                // Navigator.pushNamed(context, '/sqinputconfirm');
              },
              heroTag: 'video0',
